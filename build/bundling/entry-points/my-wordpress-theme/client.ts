...
import my_wordpress_theme_default from "my-wordpress-theme/src/index";
import frontity__wp_source_default from "@frontity/wp-source/src/index";
import frontity__tiny_router_default from "@frontity/tiny-router/src/index";
import frontity__html2react_default from "@frontity/html2react/src/index";

const packages = {
  my_wordpress_theme_default,
...
if (module["hot"]) {
  module["hot"].accept(
    ...
    () => {
      ...
      const my_wordpress_theme_default = require("my-wordpress-theme/src/index").default;
